...
PUBLIC	?data@@3U?$atomic@H@std@@A			; data
PUBLIC	?ready@@3U?$atomic@_N@std@@A			; ready
PUBLIC	?counter@@3U?$atomic@H@std@@A			; counter
;	COMDAT _Avx2WmemEnabledWeakValue
_BSS	SEGMENT
_Avx2WmemEnabledWeakValue DD 01H DUP (?)
_BSS	ENDS
_BSS	SEGMENT
?data@@3U?$atomic@H@std@@A DD 01H DUP (?)		; data
?ready@@3U?$atomic@_N@std@@A DB 01H DUP (?)		; ready
	ALIGN	4

?counter@@3U?$atomic@H@std@@A DD 01H DUP (?)		; counter
_BSS	ENDS
...
PUBLIC	??_C@_0EK@IPICMBOE@?$FLRelaxed?$FN?5GLITCH?3?5Saw?5ready?$DNtru@ ; `string'
PUBLIC	??_C@_0BJ@HGONFDLJ@Starting?5Relaxed?5test?4?4?4@ ; `string'
PUBLIC	??_C@_0CF@PDPOGBMJ@?$FLRelaxed?$FN?5Atomicity?5Error?$CB?5Coun@ ; `string'
PUBLIC	??_C@_0FM@EKDMDPJJ@Test?5finished?4?5?$CIOn?5x86?0?5glitche@ ; `string'
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$main DD	imagerel $LN248
	DD	imagerel $LN248+584
...
_DATA	ENDS
;	COMDAT ??_C@_0FM@EKDMDPJJ@Test?5finished?4?5?$CIOn?5x86?0?5glitche@
CONST	SEGMENT
??_C@_0FM@EKDMDPJJ@Test?5finished?4?5?$CIOn?5x86?0?5glitche@ DB 'Test fin'
	DB	'ished. (On x86, glitches are rare due to TSO hardware, but al'
	DB	'lowed by C++ standard)', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0CF@PDPOGBMJ@?$FLRelaxed?$FN?5Atomicity?5Error?$CB?5Coun@
CONST	SEGMENT
??_C@_0CF@PDPOGBMJ@?$FLRelaxed?$FN?5Atomicity?5Error?$CB?5Coun@ DB '[Rela'
	DB	'xed] Atomicity Error! Counter: ', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0BJ@HGONFDLJ@Starting?5Relaxed?5test?4?4?4@
CONST	SEGMENT
??_C@_0BJ@HGONFDLJ@Starting?5Relaxed?5test?4?4?4@ DB 'Starting Relaxed te'
	DB	'st...', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0EK@IPICMBOE@?$FLRelaxed?$FN?5GLITCH?3?5Saw?5ready?$DNtru@
CONST	SEGMENT
??_C@_0EK@IPICMBOE@?$FLRelaxed?$FN?5GLITCH?3?5Saw?5ready?$DNtru@ DB '[Rel'
	DB	'axed] GLITCH: Saw ready=true but data=0! (Visibility Order Vi'
	DB	'olation)', 00H				; `string'
CONST	ENDS
...
; Line 907
	mov	eax, esi
	xchg	DWORD PTR ?data@@3U?$atomic@H@std@@A, eax ; data
; Line 694
	mov	ecx, esi
	xchg	BYTE PTR ?ready@@3U?$atomic@_N@std@@A, cl ; ready
; Line 907
	mov	eax, esi
	xchg	DWORD PTR ?counter@@3U?$atomic@H@std@@A, eax ; counter
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.44.35207\include\memory
; Line 3630
	mov	ecx, 8
	call	??2@YAPEAX_K@Z				; operator new
...
; Line 129
	call	_Thrd_id
	cmp	DWORD PTR t1$2[rsp+8], eax
	je	$LN234@main
; Line 133
	movaps	xmm0, XMMWORD PTR t1$2[rsp]
	...
	xorps	xmm0, xmm0
; Line 137
	movdqa	XMMWORD PTR t1$2[rsp], xmm0
; Line 125
	cmp	DWORD PTR t2$1[rsp+8], eax
	je	$LN233@main
; Line 129
	call	_Thrd_id
	cmp	DWORD PTR t2$1[rsp+8], eax
	je	$LN234@main
; Line 133
	movaps	xmm0, XMMWORD PTR t2$1[rsp]
	...
	xorps	xmm0, xmm0
; Line 137
	movdqa	XMMWORD PTR t2$1[rsp], xmm0
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.44.35207\include\atomic
; Line 932
	mov	eax, DWORD PTR ?counter@@3U?$atomic@H@std@@A ; counter
; Line 933
	npad	1
; File C:\Users\20131\Desktop\Workplace\CppConsistency\src\mo_relaxed.cpp
; Line 56
...
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.44.35207\include\atomic
; Line 932
	mov	ebx, DWORD PTR ?counter@@3U?$atomic@H@std@@A ; counter
; Line 933
	npad	1
; File C:\Users\20131\Desktop\Workplace\CppConsistency\src\mo_relaxed.cpp
; Line 57
...
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.44.35207\include\atomic
; Line 917
	mov	DWORD PTR ?data@@3U?$atomic@H@std@@A, 42 ; data, 0000002aH
; Line 704
